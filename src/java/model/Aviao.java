...
public class Aviao extends Modal {
    ...
    public Aviao(int codigo) {
        this.codigo = codigo;
    }

    public Aviao(int codigo, int capacidade, int anoFabricacao, String tipo, String modelo, boolean situacao) {
        this.codigo = codigo;
    ...
    public String verificarCapacidade() {
        ...
        if(super.getQtdPessoas() > super.getCapacidade()) {
            return "Aviao acima da capacidade!";
        } 
